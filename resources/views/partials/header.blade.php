<header id="header" class="header {{(!is_single()? 'mb-4':'mb-lg-4')}}">
  <div class="container p-0 pl-md-3 pr-md-3">
    ...
    @if (has_nav_menu('primary_navigation'))
      {!! wp_nav_menu(['theme_location' => 'primary_navigation', 'container_class' =>'primary-nav primary-m-nav pt-2 pb-2 pt-md-2 pb-md-2 pr-md-3 pl-3', 'menu_class' => 'nav owl-carousel owl-theme menu-carousel', 'container_id' => 'container-m-nav']) !!}
    @endif
  </div>
</header>
