<header id="header" class="header">
  <div class="container">
    <div class="header__inner pt-3 pb-5 pt-md-4 pb-md-5 d-flex justify-content-between align-items-center">
      ...
      @if (has_nav_menu('primary_navigation'))
        {!! wp_nav_menu(['theme_location' => 'primary_navigation', 'container_class' =>'primary-nav', 'menu_class' => 'nav']) !!}
      @endif
